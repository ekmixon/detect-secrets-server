...
class TestFileStorage(object):
    ...
    def test_setup_creates_directories(self, file_storage, mock_rootdir):
        with assert_directories_created([mock_rootdir, f'{mock_rootdir}/repos', f'{mock_rootdir}/tracked']):
...
class TestFileStorageWithLocalGit(object):
    ...
    def test_setup_creates_directories(self, local_file_storage, mock_rootdir):
        with assert_directories_created([mock_rootdir, f'{mock_rootdir}/tracked', f'{mock_rootdir}/tracked/local']):
    ...
    def test_get_success(self, local_file_storage, mock_rootdir):
        with mock_open() as m:
            ...
            m.assert_called_with(f'{mock_rootdir}/tracked/local/mock_filename.json')
